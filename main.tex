...
\begin{document}
	...
	\begin{abstract}
		...
		Studying their properties provide a better understanding of some physical models for materials, as some porous materials are modelled using percolations.
		In this paper, we study mathematical properties of percolations in any dimensions, and make numerical experiments on the two and three dimensional cases.
		...
		Finally, we will extend techniques used before in the special case of two dimensions to acquire knowledge in more general settings. 
	\end{abstract}
